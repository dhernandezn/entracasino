      ...
      <div class="user_card">
        <div class="d-flex justify-content-center">
          <div class="brand_logo_container">
            <img src="css/images/logo2.png" class="brand_logo" alt="Logo">
          </div>
        </div>
        ...
        <div class="mt-4">
          <div class="d-flex justify-content-center links">
            Para ingresar al sistema debes registrarte<!-- <a href="#" class="ml-2">Sign Up</a>-->
          </div>
          <div class="d-flex justify-content-center links">
            Problemas? llamar al 4041<!-- <a href="#" class="ml-2">Sign Up</a>-->
          </div>
        </div>
      </div>
    </div>
